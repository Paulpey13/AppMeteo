...
set CLASSPATH=%APP_HOME%\lib\appmeteo-0.0.0.jar;%APP_HOME%\lib\json.jar;%APP_HOME%\lib\keap-0.3.0.jar;%APP_HOME%\lib\ikonli-javafx-11.1.0.jar;%APP_HOME%\lib\ikonli-fontawesome5-pack-11.1.0.jar;%APP_HOME%\lib\ikonli-material-pack-11.1.0.jar;%APP_HOME%\lib\griffon-javafx-2.15.1.jar;%APP_HOME%\lib\controlsfx-11.0.0-RC2.jar;%APP_HOME%\lib\javafx-fxml-11.0.2-win.jar;%APP_HOME%\lib\javafx-fxml-11.0.2.jar;%APP_HOME%\lib\javafx-web-11.0.2-win.jar;%APP_HOME%\lib\javafx-web-11.0.2.jar;%APP_HOME%\lib\javafx-controls-11.0.2-win.jar;%APP_HOME%\lib\javafx-controls-11.0.2.jar;%APP_HOME%\lib\javafx-media-11.0.2-win.jar;%APP_HOME%\lib\javafx-media-11.0.2.jar;%APP_HOME%\lib\javafx-graphics-11.0.2-win.jar;%APP_HOME%\lib\javafx-graphics-11.0.2.jar;%APP_HOME%\lib\javafx-base-11.0.2-win.jar;%APP_HOME%\lib\javafx-base-11.0.2.jar;%APP_HOME%\lib\kotlin-stdlib-1.3.10.jar;%APP_HOME%\lib\ikonli-core-11.1.0.jar;%APP_HOME%\lib\griffon-core-2.15.1.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.3.10.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\javax.inject-1.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar
